...
OnLevelInit = function()
    ...
    PreloadCharacter("TwistedBlueWraith")
    PreloadCharacter("TwistedTinyWraith")
    PreloadCharacter("Lizard")
    PreloadCharacter("TwistedGolem")
    PreloadCharacter("TwistedYoungLizard")
    PreloadCharacter("TwistedSmallWolf")
    PreloadCharacter("TwistedGiantWolf")
    PreloadCharacter("RabidWolf")
    PreloadCharacter("Ghast")
    PreloadCharacter("blueDragon")
    PreloadCharacter("TwistedLizardElder")
    ...
    SpawnTable.WaveSpawnRate = 35000
...
GetMinionSpawnInfo = function(i, j, k, l, F)
    ...
    if F ~= LAST_WAVE then
        ...
        if totalMinionsRemaining <= BARRACKSCOUNT * 7 then
            if totalMinionsRemaining <= 0 then
                ...
                --if totalMinionsRemaining >= BARRACKSCOUNT * 3 then
  ...
  --      lNumOfCasterMinionsPerWave = 0
   ...
   -- else
   --     if SPECIAL_MINION_MODE == "SpecialPowerMinion" then
   --         lNumOfMeleeMinionsPerWave = 0
